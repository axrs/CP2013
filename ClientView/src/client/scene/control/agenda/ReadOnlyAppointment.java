package client.scene.control.agenda;
...
public class ReadOnlyAppointment implements jfxtras.labs.scene.control.Agenda.Appointment {
    ...
    public ReadOnlyAppointment withStartTime(Calendar value) {
        startTimeObjectProperty.setValue(value);
        return this;
    }
    ...
    public ReadOnlyAppointment withEndTime(Calendar value) {
        endTimeObjectProperty.setValue(value);
        return this;
    }
    ...
    public ReadOnlyAppointment withWholeDay(Boolean value) {
        setWholeDay(value);
        return this;
    }
    ...
    public ReadOnlyAppointment withSummary(String value) {
        setSummary(value);
        return this;
    }
    ...
    public ReadOnlyAppointment withDescription(String value) {
    ...
    public ReadOnlyAppointment withLocation(String value) {
        setLocation(value);
        return this;
    }
    ...
    public ReadOnlyAppointment withAppointmentGroup(Agenda.AppointmentGroup value) {
